        ...
        <Row className="align-items-center justify-content-between g-3">
          <Col lg={6}>
            ...
            <div className="d-flex gap-3 mb-3 mt-4">
              ...
              <div>
                {/* <p className="mb-1 fw-semibold f-18">1</p> */}
                <p className="mb-0 f-15 text-muted">Delivering high-quality, affordable accommodations that align with international standards.</p>
              </div>
            </div>
            <div className="d-flex gap-3 mb-3 mt-4">
              <span className="icon-bg bg-light text-primary rounded d-flex justify-content-center align-items-center flex-shrink-0">
              ...
              <div>
                {/* <p className="mb-1 fw-semibold f-18">2</p> */}
                <p className="mb-0 f-15 text-muted">Providing comfort, convenience, and value for all types of guests. </p>
              </div>
            </div>
            <div className="d-flex gap-3 mb-3 mt-4">
              <span className="icon-bg bg-light text-primary rounded d-flex justify-content-center align-items-center flex-shrink-0">
              ...
              <div>
                {/* <p className="mb-1 fw-semibold f-18">3</p> */}
                <p className="mb-0 f-15 text-muted">Innovating with collaborations and partnerships to enhance guest experiences.</p>
              </div>
            </div>
            ...
            <div className="d-flex gap-3 mb-3 mt-4">
              ...
              <div>
                {/* <p className="mb-1 fw-semibold f-18">4</p> */}
                <p className="mb-0 f-15 text-muted">
                  Contributing to Pakistan’s economic development through sustainable and community-focused practices.
                </p>
              </div>
            </div>
